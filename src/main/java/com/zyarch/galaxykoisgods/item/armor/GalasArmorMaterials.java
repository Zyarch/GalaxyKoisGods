...
public enum GalasArmorMaterials implements StringRepresentable, ArmorMaterial {
    CULT_ROBES("cult", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (map)-> {
