...
public class GalasBlocks {
    ...
    public static final RegistryObject<Block> SAPPHIRE_ORE = register("sapphire_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().mapColor(MapColor.STONE).strength(3.0f, 3.0f)), commonProperties);
    ...
    public static final RegistryObject<Block> DEEPSLATE_SILVER_ORE = register("deepslate_silver_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_IRON_ORE).strength(4.0f, 4.0f)), commonProperties);
    public static final RegistryObject<Block> DEEPSLATE_SELENIUM_ORE = register("deepslate_selenium_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_IRON_ORE).strength(4.0f, 4.0f)), commonProperties);
    public static final RegistryObject<Block> DEEPSLATE_RUBY_ORE = register("deepslate_ruby_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_IRON_ORE).strength(4.0f, 4.0f)), commonProperties);
    public static final RegistryObject<Block> DEEPSLATE_SAPPHIRE_ORE = register("deepslate_sapphire_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_IRON_ORE).strength(4.0f, 4.0f)), commonProperties);
    public static final RegistryObject<Block> DEEPSLATE_THUNDER_STONE_ORE = register("deepslate_thunder_stone_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_IRON_ORE).strength(4.0f, 4.0f)), commonProperties);
    ...
    public static final RegistryObject<Block> SAPPHIRE_BLOCK = register("sapphire_block", () -> new DropExperienceBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().mapColor(MapColor.DEEPSLATE).strength(4.0f, 4.0f)), commonProperties);
