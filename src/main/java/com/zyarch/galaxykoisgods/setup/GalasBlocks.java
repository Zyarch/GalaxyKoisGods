...
public class GalasBlocks {
    ...
    public static final RegistryObject<Block> AMETHYST_ORE = register("amethyst_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().mapColor(MapColor.STONE).strength(3.0f, 3.0f)), commonProperties);
    ...
    public static final RegistryObject<Block> AMETHYST_BLOCK = register("amethyst_block", () -> new DropExperienceBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().mapColor(MapColor.DEEPSLATE).strength(4.0f, 4.0f)), commonProperties);
